...
contract Renderer {
    ...
    function render(uint256 _tokenId) public pure returns (string memory) {
        //TODO don't forget to query team
        uint256 team = 0;
        string memory house = 'Mileah';
    ...
    function renderPyramid() internal pure returns (string memory pyramid) {
        pyramid = string(abi.encodePacked(''));
    }
}
